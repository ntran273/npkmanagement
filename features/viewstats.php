...
if(!isset($_SESSION))
{
  ...
  $query = "SELECT P.PlayerId, S.PlayerId, P.Name_First, P.Name_Last, S.PlayingTimeMin, S.PlayingTimeSec, S.Points, S.Assists, S.Rebounds, S.GameId
    FROM Statistics S
          ...
          <table class="table table-bordered table-hover">
            <thead class="thead-dark">
              <tr class="info">
                ...
                <th scope="col">StatisticPlayerId</th>
